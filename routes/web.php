...
Route::get('/offers/view/{id}/{country_id?}/{position?}', 'Common\OffersController@viewSingleOfferInSite');
...
Route::get('country/agreements/{country_id?}/{position?}', 'Common\CountriesController@listAgreements');
Route::get('country/events/{country_id?}/{position?}', 'Common\CountriesController@listEvents');
Route::get('country/news/{country_id?}/{position?}', 'Common\CountriesController@listNews');
Route::get('country/topics/{country_id?}/{position?}', 'Common\CountriesController@listTopics');
Route::get('country/follow/{country_id?}', 'Common\CountriesController@follow');
Route::get('country/follow/index/{country_id}', 'Common\CountriesController@usersFollowers');
Route::get('country/contact_us/{country_id}/{position?}', 'Common\CountriesController@contactUs');
Route::post('/country/contact_us/{country_id}', 'Common\CountriesController@saveContactUs');
...
//shares
//Route::get('share/facebook/{link}/{title}', 'Common\ShareController@facebookShare');
//Route::get('share/twitter/{link}/{title}', 'Common\ShareController@twitterShare');
//Route::get('share/linkedin/{link}/{title}', 'Common\ShareController@linkedInShare');
//Route::get('share/gplus/{link}/{title}', 'Common\ShareController@gplusInShare');

//ogranization
Route::get('country/organization/index/{country_id?}/{position?}', 'Common\OrganizationsController@index');
Route::get('country/organization/follow/{org_id}/{offer_id?}/{country_id?}', 'Common\OrganizationsController@followOrganization');
Route::get('country/organization/{letter}/{country_id}', 'Common\OrganizationsController@filterOrganization');
Route::get('country/organization/view/{id}/{country_id?}/{position?}', 'Common\OrganizationsController@view');
Route::get('country/organization/{id}/delete', 'Common\OrganizationsController@delete');
Route::get('country/organization/follow/{id}', 'Common\OrganizationsController@follow');
Route::get('country/organization/{id}/edit/{country_id}/{position?}', 'Common\CountriesController@editOrganization');
Route::post('country/organization/{id}/edit', 'Common\OrganizationsController@edit');
...
Route::post('country/topics/{id}/edit', 'Common\Blog\PostsController@updatePost');

//news
Route::post('country/news/new', 'Common\NewsController@storeNews');
Route::post('country/news/{id}/edit', 'Common\NewsController@updateNews');
...
//  Country Calls
Route::get('country/calls/{country_id}/{position}', 'Common\CountriesController@viewAllCalls')->name('country.calls');
Route::get('country/calls/{id}/view', 'Common\CallsController@viewCall');

//country offers
Route::get('country/offers/{country_id?}/{position?}', 'Common\CountriesController@viewAllOffers')->name('country.offers');
...
Route::group(['middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('panel/countries/country/{id}/edit', 'Common\CountriesController@editCountry');
    Route::post('panel/countries/country/{id}/edit', 'Common\CountriesController@updateCountry');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    //    Topics
    Route::get('country/topics/new/{country_id?}/{position?}', 'Common\CountriesController@newTopic');
    Route::get('country/topics/edit/{id}/{country_id?}/{position?}', 'Common\CountriesController@editTopic');
...
//    Country News
    Route::get('country/news/new/{country_id?}/{position?}', 'Common\CountriesController@newNews');
    Route::get('country/news/edit/{id}/{country_id?}/{position?}', 'Common\CountriesController@editNews');
    Route::post('country/news/{id}/delete', 'Common\NewsController@deleteNews');
    Route::get('country/news/view/{id}/{country_id?}/{position?}', 'Common\NewsController@viewNews');

    //  Country Agreements
    Route::get('country/agreements/new/{country_id?}/{position?}', 'Common\CountriesController@newAgreement');
    Route::get('country/agreements/{id}/edit/{country_id?}/{position?}', 'Common\CountriesController@editAgreement');
    Route::post('country/agreements/{id}/delete', 'Common\AgreementsController@deleteAgreement');
    //  Country Events
    Route::get('country/events/new/{country_id?}/{position?}', 'Common\CountriesController@newEvent');
    Route::get('country/events/{id}/edit/{country_id?}/{position?}', 'Common\CountriesController@editEvent');
    Route::post('country/events/{id}/delete', 'Common\EventsController@deleteEvent');


    // New Call
    Route::get('country/calls/new/{country_id?}/{position?}', 'Common\CountriesController@newCall');

    // Edit Calls
    Route::get('country/calls/{id}/edit/{country_id?}/{position?}', 'Common\CountriesController@editCall');
    ...
    //  Country Offers
    Route::get('country/offers/new/{country_id?}/{position?}', 'Common\CountriesController@newOffer');
    Route::post('country/offers/new', 'Common\OffersController@storeOffer');

    Route::get('country/offers/{id}/edit/{country_id?}/{position?}', 'Common\CountriesController@editOffer');
    ...
    // Country Users
    Route::get('country/users/{country_id?}/{position?}', 'Common\CountriesController@listAllUsers');
    Route::get('country/users/new/{country_id?}/{position?}', 'Common\CountriesController@newUser');
    Route::post('country/users/new', 'Common\SubUsersController@storeUser');
//    Route::get('country/users/edit/{id}/{country_id?}/{position?}', 'Common\CountriesController@editUser');
    Route::get('users/edit/{id}/{country_id?}/{position?}', 'Common\CountriesController@editUser');
    Route::post('users/edit/{id}', 'Common\CountriesController@saveUser');
...
//    filter
    ...
    //generate pdf
    Route::get('account/pdf', 'Pdf\PDFController@pdf');
...
//Excel
Route::get('organization/export/{country_id}', 'Excel\ExcelController@export');
