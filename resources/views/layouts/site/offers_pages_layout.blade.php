...
@section('content')
    ...
    <div class="bread-crumb">
        <div class="page-container reset">
            ...
            {{--@if(isset($list))--}}
            {{--<span class="fa fa-angle-right"></span>&ensp;--}}
            {{--<a href="{{ url($url..$country_id.'/'.$position) }}" class="active">{{ $list }}</a>&ensp;--}}
            {{--@endif--}}
            <span class="fa fa-angle-right"></span>&ensp;
            <a href="{{url('country/offers/'.$country_id.'/'.$position)}}" class="active"> {{ $parent_title }} </a>
            &ensp;<span
                    class="fa fa-angle-right"></span>&ensp; <a href="#"
