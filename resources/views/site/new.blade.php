...
<div class="page-wrapper">
    ...
    <header class="main-header fixed">
        ...
        <div class="header-lower">
            <div class="auto-container clearfix">
                <!--Logo-->
                <div class="logo"><a href="index.html"><img src="{{ asset('images/logo.png') }}" alt="Volunteer" title="Volunteer"></a></div>
        ...
        <div class="tp-banner-container">
            <div class="tp-banner" >
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-thumb="{{ asset('images/main-slider/image-1.jpg') }}"  data-saveperformance="off"  data-title="Donation is Better">
                    ...
                    <li data-transition="slideup" data-slotamount="1" data-masterspeed="1000" data-thumb="{{asset('images/main-slider/image-2.jpg')}}"  data-saveperformance="off"  data-title="Donation is Better">
                    ...
                    <li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-thumb="{{asset('images/main-slider/image-3.jpg')}}"  data-saveperformance="off"  data-title="Donation is Better">
                        <img src="{{asset('images/main-slider/image-3.jpg')}}"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
    ...
    <section class="tri-column-fluid">
        <div class="tri-column-outer clearfix">
            ...
            <!--Carousel Column-->
            <article class="column carousel-column" style="background-image:url({{ asset('images/background/carousel-bg.jpg') }});">
                <div class="pattern-layer"></div>
        ...
        <div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 column project-column wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
                    <article class="column-inner hvr-float-shadow">
                        <figure class="image-box">
                            <a href="#"><img src="{{ asset('images/resource/image-1.jpg') }}" alt="" title="Volunteer"></a>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 column project-column wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1000ms">
                    <article class="column-inner hvr-float-shadow">
                        <figure class="image-box">
                            <a href="#"><img src="{{ asset('images/resource/image-2.jpg') }}" alt="" title="Volunteer"></a>
                            <div class="icon-box"><a href="#" class="heart-icon img-circle"><span class="flaticon-favorite21"></span></a></div>
                        </figure>
                        <div class="lower-part">
                            <div class="text">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 column project-column wow fadeInLeft" data-wow-delay="600ms" data-wow-duration="1000ms">
                    <article class="column-inner hvr-float-shadow">
                        <figure class="image-box">
                            <a href="#"><img src="{{ asset('images/resource/image-3.jpg') }}" alt="" title="Volunteer"></a>
                            <div class="icon-box"><a href="#" class="heart-icon img-circle"><span class="flaticon-favorite21"></span></a></div>
                        </figure>
                        <div class="lower-part">
                            <div class="text">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 column project-column wow fadeInLeft" data-wow-delay="900ms" data-wow-duration="1000ms">
                    <article class="column-inner hvr-float-shadow">
                        <figure class="image-box">
                            <a href="#"><img src="{{ asset('images/resource/image-4.jpg') }}" alt="" title="Volunteer"></a>
                            <div class="icon-box"><a href="#" class="heart-icon img-circle"><span class="flaticon-favorite21"></span></a></div>
                        </figure>
                        <div class="lower-part">
                            <div class="text">
        ...
        <div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 column team-member">
                    <article class="column-inner hvr-float-shadow">
                        <figure class="image-box">
                            <a href="#"><img src="{{ asset('images/resource/team-1.jpg') }}" alt="" title="Volunteer"></a>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 column team-member">
                    <article class="column-inner hvr-float-shadow">
                        <figure class="image-box">
                            <a href="#"><img src="{{ asset('images/resource/team-2.jpg') }}" alt="" title="Volunteer"></a>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 column team-member">
                    <article class="column-inner hvr-float-shadow">
                        <figure class="image-box">
                            <a href="#"><img src="{{ asset('images/resource/team-3.jpg') }}" alt="" title="Volunteer"></a>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 column team-member">
                    <article class="column-inner hvr-float-shadow">
                        <figure class="image-box">
                            <a href="#"><img src="{{ asset('images/resource/team-4.jpg') }}" alt="" title="Volunteer"></a>
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 column wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1000ms">
                    <article class="column-inner hvr-float">
                        <figure class="image-box">
                            <a href="#"><img src="{{ asset('images/resource/image-5.jpg') }}" alt="" title="Volunteer Program"></a>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 column wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                    <article class="column-inner hvr-float">
                        <figure class="image-box">
                            <a href="#"><img src="{{ asset('images/resource/image-6.jpg') }}" alt="" title="Volunteer Program"></a>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 column wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                    <article class="column-inner hvr-float">
                        <figure class="image-box">
                            <a href="#"><img src="{{asset('images/resource/image-7.jpg')}}" alt="" title="Volunteer Program"></a>
    ...
    <!--Fact Counter-->
    <section class="fact-counter" style="background-image:url({{ asset('images/-2.jpg') }});">
        <div class="auto-container">
            <div class="row clearfix">
    ...
    <section class="sponsors-section">
        <div class="container">
            <ul class="slider">
                <li><a href="#"><img src="{{ asset('images/clients/logo-6.png') }}" alt="" title=""></a></li>
                <li><a href="#"><img src="{{ asset('images/clients/logo-7.png') }}" alt="" title=""></a></li>
                <li><a href="#"><img src="{{ asset('images/clients/logo-8.png') }}" alt="" title=""></a></li>
                <li><a href="#"><img src="{{ asset('images/clients/logo-9.png') }}" alt="" title=""></a></li>
                <li><a href="#"><img src="{{ asset('images/clients/logo-10.png') }}" alt="" title=""></a></li>
            </ul>
        </div>
    </section>
